...
export const BRAND_TAGLINE = "Community-driven road safety";

export const HERO_HEADLINE = "Stay ahead of nearby road disruptions";

export const SETUP_STEPS = [
  { number: "1", title: "Create your account", detail: "Sign up securely in under a minute." },
  { number: "2", title: "Start your trial", detail: "Pick a plan. Cancel anytime securely via Stripe." },
